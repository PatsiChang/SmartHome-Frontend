...
//       }else if(action === ACTION.post && directory === "") {
...
//       // await getData({recipeName: "GetData"});
//       return recipeID;
//       }else if(action === ACTION.post && directory === "/getRecipeByToken")  {
//         const response = await fetch(process.env.NEXT_PUBLIC_API_URL + "/recipe" + directory, {
//           method: 'POST',
//           headers: {
//             "Content-Type": 'application/json'
//           },
...
//         })
//         const recipeListByToken: ReceipeData[] = await response.json();
//         console.log("After Fetch recipes",recipeListByToken )
//         setRecipeList(recipeListByToken);
//         return(recipeList);
...
//   const getData = fetchData(ACTION.post,"/getRecipeByToken");
