...
// import { Form, onchangeEvent } from "./RegisterRecipe";
...
// }
// const UpdateRecipe = (recipe: Form | null) => {
...
//     // const[ingredientInputUpdate, setIngredientInputUpdate] = useState<Ingredient[]>([]);
//     // const[stepsInputUpdate, setStepsInputUpdate] = useState<Steps[]>([{ id: '', step: '' }]);
...
//         let steps : string[] = [];
//         stepsInputUpdate.forEach((step)=>steps.push(step.step));
...
//     const cancelUpdateRecipe = () => recipe = null;
    
//         return recipe ? (
//             <div className="registerRecipe">
//                 <div className="registerRecipeCloseBtn">
//                     <button className="close-btn" onClick={cancelUpdateRecipe}>cancel update</button>
//                 </div>
...
//                     <div><StepsList stepsInput={stepsInputUpdate} setStepsInput={setStepsInputUpdate}/></div>

//                     {/* <input type="textfield" id="steps" name="steps" placeholder=" Steps"/> */}
//                     <span id="responce"></span>
//                     {/* <button id="addStepsBtn">Add Steps</button> */}
//                     <button type="submit" id="submitRecipe">Save</button>
